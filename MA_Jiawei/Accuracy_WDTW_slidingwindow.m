...
title1 = { 'Maneuver start time', 'Maneuver stop time', 'WDTW Labeling Ego lat' };
title2 = { 'Maneuver start time', 'Maneuver stop time', 'WDTW Labeling Object lat'};
...
Output_label1 = xlswrite('C:\Users\scuwa\Desktop\MA_Jiawei\Data\Accuracy_dtw_slidingwindow.xlsx',output1 ,'results_WDTW',cellnames_ego);
Output_label2 = xlswrite('C:\Users\scuwa\Desktop\MA_Jiawei\Data\Accuracy_dtw_slidingwindow.xlsx',output2 ,'results_WDTW',cellnames_object);
Output_label3 = xlswrite('C:\Users\scuwa\Desktop\MA_Jiawei\Data\Accuracy_dtw_slidingwindow.xlsx',output3 ,'results_WDTW',cellnames_gt_ego);
Output_label4 = xlswrite('C:\Users\scuwa\Desktop\MA_Jiawei\Data\Accuracy_dtw_slidingwindow.xlsx',output4 ,'results_WDTW',cellnames_gt_object);
