...
{
	DDefInt (NULL, "Ego_long_label", "", &Ego_long_label, DVA_IO_In);
	DDefInt (NULL, "Ego_lat_label", "", &Ego_lat_label, DVA_IO_In);
	...
	DDefDouble (NULL, sbuf, "", &UserOut[i], DVA_IO_In);
    }
    RBS_DeclQuants();
}
...
User_Calc (double dt)
{
	/*Ground Truth labeling Ego Long*/
	// Basic Maneuver: Braking
	if (Car.ConBdy1.a_1[0] < -1) {
		Ego_long_label = 1;
	// Basic Maneuver: Accelerating
	} else if (Car.ConBdy1.a_1[0] > 1) {
		Ego_long_label = 2;
	// Basic Maneuver: Constant Driving
	} else {
		Ego_long_label = 0;
	}

	/*Ground Truth labeling Ego Lat*/
	//TODO
	
	/*Ground Truth labeling Traffic Long*/
	//TODO
	
	/*Ground Truth labeling Traffic Lat*/
	//TODO
