...
MainThread_FinishCycle (unsigned long long CycleNo64)
{
    ...
    CM_XCP_ApoMsg_Send(TimeGlobal, CycleNo64);
    CM_CCP_ApoMsg_Send(TimeGlobal, CycleNo64);
#if defined(CM_HIL)
    User_ApoMsg_Send    (TimeGlobal, CycleNo64);
    ADTF_ApoMsg_Send();
    SimCore_ApoMsg_Send (TimeGlobal, CycleNo64);
#else
