...
Car2Vehicle (void)
{
	...
	Vehicle.PoI_Pos[0] =	ExtInp_IF.User1.Value;//Car.PoI.x;
	Vehicle.PoI_Pos[1] =	ExtInp_IF.User2.Value;//Car.PoI.y;
    ...
    Vehicle.Yaw =	 ExtInp_IF.User3.Value;//Car.Fr1.Yaw;
    ...
    Vehicle.Fr1A.t_0[0] = ExtInp_IF.User1.Value;//Car.Fr1.x;
    Vehicle.Fr1A.t_0[1] = ExtInp_IF.User2.Value;//Car.Fr1.y;
