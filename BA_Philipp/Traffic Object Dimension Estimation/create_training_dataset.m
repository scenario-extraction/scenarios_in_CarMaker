...
% *************************************************************************
%
% This script creates a table with training data corresponding to ONE traffic object.
% Multiple of these tables put together make up the final training set.
...
description = "Porsche_911Turbo_2012";
...
dist_x.from_front_camera = dist_x.raw - (front_cam_pos_x - sensor_x);
...
%% Save train as .mat
% save('train_Porsche_911Turbo_2012.mat', "train");
