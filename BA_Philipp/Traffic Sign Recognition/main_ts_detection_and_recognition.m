...
% *************************************************************************
%
% This script is for detecting and recognising traffic signs in a series 
% of images
%
% ACF detector "ACFDetector" for traffic sign detection and 
% CNN "RecognitionNet" for traffic sign classification have to be present 
% in the same folder as this script in order to run it 
%
% All relevant data must be present in the correct subfolders of "...\007 Traffic Sign Recognition\001 Data"
...
fprintf(1, '\n');
disp('Traffic sign detection and recognition complete. Resulting tensors are stored in variable "tensors".');
